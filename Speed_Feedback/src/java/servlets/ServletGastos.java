 ...
 */
@WebServlet(name = "ServletGastos", urlPatterns = {"/ServletGastos"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                objSql.conectar();
                ResultSet rsDatos = objSql.consulta("call spGraficaServicio();");
                while (rsDatos.next()) {
            ...
            out.println(" <nav class=\"navbar navbar-inverse navbar-fixed-top\">\n"
                    ...
                    + "                </ul>\n"
                    + "        </nav>");
            out.print("<br><br><br>" + "<h1 style=\"color: white\">Gráfica de concepto de gastos </h1>");
