 ...
 * @author Alumno
 */
@WebServlet(name = "ServletPresta", urlPatterns = {"/ServletPresta"})
public class ServletPresta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                objSql.conectar();
                ResultSet rsDatos = objSql.consulta("call spGraficaPresta();");
                while (rsDatos.next()) {
                    strDatosGraf += "[\"" + rsDatos.getString("prestador") + "\", " + rsDatos.getString("total") + ", \"#" + rsDatos.getString("color") + "\"],\n";
                }

            } catch (Exception xxxD) {
                out.println("<script>alert('Tienes un error' " + xxxD + "));");
            }
            out.println("<title>Grafica deprestadores</title>"
                    ...
                    + "        [\"Element\", \"Servicios brindados\", { role: \"style\" } ],\n"
                    + strDatosGraf
                    + "      ]);\n"
                    + "\n"
            ...
            out.print("<br><br><br>" + "<h1 style=\"color: white\">Grafica de prestadores</h1>");
